  ...
  return (
    <div className='p-8'>
        <div className='mt-4 mb-20 w-full text-right p-4'>
          <p className="text-6xl md:text-8xl xl:p-8 mt-1 font-bold  text-textBrown font-heading-barlow uppercase">
            Work Experience
          </p>
        </div>
        <VerticalTimeline>
            ...
            key={index}
                className=""
                contentStyle={{ background: '#292420', color: '#000', borderRadius: "15px", boxShadow: "10px 10px 15px rgba(0, 0, 0, 0.3)" }}
